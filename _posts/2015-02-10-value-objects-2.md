...
These `Embeddable` classes provides a convenient mapping for Value Objects. Here are the pertinent parts of the `Month` class from [Part 1](/value-objects), annotated as a JPA `Embeddable`:
