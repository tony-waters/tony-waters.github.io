...
In my [previous post]({{ "/2015/02/05/ddd-value-objects-part-1.html" | prepend: site.baseurl }}) I looked at the [Domain Driven Design](http://dddcommunity.org/) concept of Value Objects as outlined by Eric Evans (2003). In this second post I want to show how we can persist such objects to a relational database using JPA.
