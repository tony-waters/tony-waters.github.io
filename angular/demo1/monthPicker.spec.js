describe('Given a MonthPicker directive', function () {
    ...
    beforeEach(module('monthPicker.html'))
    
    describe('when in default mode', function() {
        
        beforeEach(inject(function ($templateCache, $rootScope, $compile, $controller) {
            
            // get the monthPicker template, and store it on cach in a way directive expects
            var template = $templateCache.get('monthPicker.html');
            $templateCache.put('/angular/monthPicker.html',template);
